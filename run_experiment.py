...
@click.argument('test_split_name', default='test')
@click.argument('valid_split_name', default='valid')
@click.argument('train_split_name', default='train')
def run(config_file, test_split_name, valid_split_name, train_split_name):
    ...
    with tf.Session(config=sess_config) as sess:
        ...
        data.setup(test_split_name, valid_split_name, train_split_name)
